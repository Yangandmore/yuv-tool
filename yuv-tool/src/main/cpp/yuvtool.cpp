...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I444ToI420(JNIEnv *env, jclass clazz, jbyteArray i444, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i444);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I444ToARGB(JNIEnv *env, jclass clazz, jbyteArray i444, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i444);
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I444ToAGBR(JNIEnv *env, jclass clazz, jbyteArray i444, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i444);
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToI420(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = width_half * (height >> 1);
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToABGR(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToBGRA(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToRGBA(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToARGB(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToUYVY(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I422ToYUY2(JNIEnv *env, jclass clazz, jbyteArray i422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i422);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I400ToI420(JNIEnv *env, jclass clazz, jbyteArray i400, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i400);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = width_half * (height >> 1);
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I400ToARGB(JNIEnv *env, jclass clazz, jbyteArray i400, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(i400);
    int size_y = width * height;
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_I400ToMirror(JNIEnv *env, jclass clazz, jbyteArray i400, jint width,
                                       jint height) {
    jsize len = env->GetArrayLength(i400);
    int size_y = width * height;
    if (len <= 0) {
    ...
    jbyteArray i400_mirror = env->NewByteArray(size_y * 4);
    unsigned char* i400_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(i400, 0));
    unsigned char* i400_mirror_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(i400_mirror, 0));

    int ret = libyuv::I400Mirror(
            i400_data, width,
            i400_mirror_data, width,
            width, height
    );

    env->ReleasePrimitiveArrayCritical(i400_mirror, i400_mirror_data, 0);
    env->ReleasePrimitiveArrayCritical(i400, i400_data, 0);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_YUY2ToI420(JNIEnv *env, jclass clazz, jbyteArray yuy2, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(yuy2);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = width_half * (height >> 1);
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_YUY2ToI422(JNIEnv *env, jclass clazz, jbyteArray yuy2, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(yuy2);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_YUY2ToNV12(JNIEnv *env, jclass clazz, jbyteArray yuy2, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(yuy2);
    int size_y = width * height;
    if (len <= 0) {
    ...
    jbyteArray nv12 = env->NewByteArray(size_y * 2);
    unsigned char* yuy2_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(yuy2, 0));
    unsigned char* nv12_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(nv12, 0));
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_YUY2ToY(JNIEnv *env, jclass clazz, jbyteArray yuy2, jint width,
                                  jint height) {
    jsize len = env->GetArrayLength(yuy2);
    int size_y = width * height;
    if (len <= 0) {
    ...
    jbyteArray y = env->NewByteArray(size_y);
    unsigned char* yuy2_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(yuy2, 0));
    unsigned char* y_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(y, 0));

    int ret = libyuv::YUY2ToY(
            yuy2_data, width * 2,
            y_data, width,
            width, height
    );

    env->ReleasePrimitiveArrayCritical(y, y_data, 0);
    env->ReleasePrimitiveArrayCritical(yuy2, yuy2_data, 0);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_YUY2ToARGB(JNIEnv *env, jclass clazz, jbyteArray yuy2, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(yuy2);
    int size_y = width * height;
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_UYVYToI420(JNIEnv *env, jclass clazz, jbyteArray uyvy, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(uyvy);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = width_half * (height >> 1);
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_UYVYToI422(JNIEnv *env, jclass clazz, jbyteArray uyvy, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(uyvy);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_UYVYToNV12(JNIEnv *env, jclass clazz, jbyteArray uyvy, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(uyvy);
    int size_y = width * height;
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_UYVYToARGB(JNIEnv *env, jclass clazz, jbyteArray uyvy, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(uyvy);
    int size_y = width * height;
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGBToJ400(JNIEnv *env, jclass clazz, jbyteArray argb, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(argb);
    int size_y = width * height;
    if (len <= 0) {
    ...
    jbyteArray j400 = env->NewByteArray(size_y);
    unsigned char* argb_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(argb, 0));
    unsigned char* j400_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(j400, 0));
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGBToJ420(JNIEnv *env, jclass clazz, jbyteArray argb, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(argb);
    int width_half = width >> 1;
    int size_y = width * height;
    ...
    jbyteArray j420 = env->NewByteArray(size_y * 3 / 2);
    unsigned char* argb_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(argb, 0));
    unsigned char* j420_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(j420, 0));

    int ret = libyuv::ARGBToJ420(
            argb_data, width * 4,
            j420_data, width,
            j420_data + size_y, width_half,
            j420_data + size_y + size_uv, width_half,
            width, height
    );

    env->ReleasePrimitiveArrayCritical(argb, argb_data, 0);
    env->ReleasePrimitiveArrayCritical(j420, j420_data, 0);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGBToJ422(JNIEnv *env, jclass clazz, jbyteArray argb, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(argb);
    int width_half = width >> 1;
    int size_y = width * height;
    ...
    jbyteArray j422 = env->NewByteArray(size_y * 2);
    unsigned char* argb_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(argb, 0));
    unsigned char* j422_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(j422, 0));

    int ret = libyuv::ARGBToJ422(
            argb_data, width * 4,
            j422_data, width,
            j422_data + size_y, width_half,
            j422_data + size_y + size_uv * 2, width_half,
            width, height
    );

    env->ReleasePrimitiveArrayCritical(argb, argb_data, 0);
    env->ReleasePrimitiveArrayCritical(j422, j422_data, 0);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_BGRAToI420(JNIEnv *env, jclass clazz, jbyteArray bgra, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(bgra);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = size_y >> 2;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_BGRAToARGB(JNIEnv *env, jclass clazz, jbyteArray bgra, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(bgra);
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGB4444ToI420(JNIEnv *env, jclass clazz, jbyteArray argb4444, jint width,
                                         jint height) {
    jsize len = env->GetArrayLength(argb4444);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = size_y >> 2;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGB4444ToARGB8888(JNIEnv *env, jclass clazz, jbyteArray argb4444,
                                             jint width, jint height) {
    jsize len = env->GetArrayLength(argb4444);
    int size_y = width * height;
    ...
    jbyteArray argb8888 = env->NewByteArray(size_y * 4);
    unsigned char* argb4444_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(argb4444, 0));
    unsigned char* argb8888_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(argb8888, 0));

    int ret = libyuv::ARGB4444ToARGB(
            argb4444_data, width * 2,
            argb8888_data, width * 4,
            width, height
    );

    env->ReleasePrimitiveArrayCritical(argb8888, argb8888_data, 0);
    env->ReleasePrimitiveArrayCritical(argb4444, argb4444_data, 0);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGB1555ToI420(JNIEnv *env, jclass clazz, jbyteArray argb1555, jint width,
                                         jint height) {
    jsize len = env->GetArrayLength(argb1555);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = size_y >> 2;
    ...
    jbyteArray i420 = env->NewByteArray(size_y * 3 / 2);
    unsigned char* argb1555_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(argb1555, 0));
    unsigned char* i420_data = static_cast<unsigned char *>(env->GetPrimitiveArrayCritical(i420, 0));

    int ret = libyuv::ARGB1555ToI420(
            argb1555_data, width * 2,
            i420_data, width,
            i420_data + size_y, width_half,
            i420_data + size_y + size_uv, width_half,
            width, height
    ...
    env->ReleasePrimitiveArrayCritical(i420, i420_data, 0);
    env->ReleasePrimitiveArrayCritical(argb1555, argb1555_data, 0);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_ARGB1555ToARGB(JNIEnv *env, jclass clazz, jbyteArray argb1555, jint width,
                                         jint height) {
    jsize len = env->GetArrayLength(argb1555);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_J400ToARGB(JNIEnv *env, jclass clazz, jbyteArray j400, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(j400);
    int size_y = width * height;
    if (len <= 0) {
        return NULL;
    }
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_J420ToARGB(JNIEnv *env, jclass clazz, jbyteArray j420, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(j420);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = width_half * (height >> 1);
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_J420ToABGR(JNIEnv *env, jclass clazz, jbyteArray j420, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(j420);
    int width_half = width >> 1;
    int size_y = width * height;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_J422ToARGB(JNIEnv *env, jclass clazz, jbyteArray j422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(j422);
    int width_half = width >> 1;
    int size_y = width * height;
    int size_uv = width_half * (height >> 1);
    if (len <= 0) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_yuv_tool_YuvTool_J422ToABGR(JNIEnv *env, jclass clazz, jbyteArray j422, jint width,
                                     jint height) {
    jsize len = env->GetArrayLength(j422);
    int width_half = width >> 1;
    int size_y = width * height;
